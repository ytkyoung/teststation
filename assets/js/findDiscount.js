...
//   return Math.round((price - price * (discount / 100) + Number.EPSILON) * 100) / 100;
// }

const dis = (price, discount) => Math.round((price - price * (discount / 100) + Number.EPSILON) * 100) / 100;

const result = dis(1500, 50);

console.log(result);

const testData = `Test.assertEquals(dis(100, 75), 25)
